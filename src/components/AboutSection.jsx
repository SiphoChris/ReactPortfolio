...
const About = () => {
  ...
  return (
    <section id="ABOUT" className="about-section bg-gray-200 py-16 px-4 md:px-24">
      <h2 className="text-center text-3xl font-bold mb-16">About Me</h2>
      <article className="personal-info flex flex-col md:flex-row items-center justify-center gap-16 md:gap-32">
